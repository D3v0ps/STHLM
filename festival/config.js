...
window.APP_CONFIG = {
  ...
  fallbackData: {
    settings: {
      ...
      whoCanApplyText: "Bazaren är öppen för företagare, kreatörer, föreningar och personer som vill sälja eller presentera produkter och tjänster som passar familjer och besökare. Det kostar inget att anmäla sig och få ett stånd — men 10 % av försäljningsintäkterna under festivaldagen tillfaller moskén. I formuläret vill vi att du beskriver vad du planerar att erbjuda och vilket stånd du behöver.",
