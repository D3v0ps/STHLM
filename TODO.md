...
- [ ] **OG-bild 1200x630** — baserad på flyern, sparas i `festival/assets/og-festival.jpg`
- [ ] **Logotyp** — kvadratisk + horisontell, sparas i `festival/assets/`
...
- [x] **Klistra in Web App-URL** i `festival/config.js` och `festival-admin/config.js`
- [ ] **Beställ subdomän eller subkatalog** på One.com (rekommendation: subkatalog `/festival/` och `/festival-admin/`)
